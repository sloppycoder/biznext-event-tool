...
def json2protobuf(topic: str, message_pb):
    """
    convert a protobuf message to an obj.
    return the message as is in case the message is not recognized
    """
    try:
        obj = TYPES_MAP[topic]()
...
def produce(servers: str, topic: str, message_pb) -> int:
...
def consume(
    servers: str, topic: str, group_id: str, duration: int = 3
) -> Generator[Tuple[str, Any, datetime], None, None]:
    ...
    try:
        ...
        while now_t - start_t < duration:
            ...
            yield key, json2protobuf(topic, message_pb), datetime.fromtimestamp(timestamp / 1000)
    ...
    if sys.argv[1] == "consume":
        ...
        for key, message_pb, timestamp in consume(bootstrap_servers, topic, "biznext-event-tool", duration):
            try:
                ...
                print(json_format.MessageToJson(message_pb))
        ...
        with open(sys.argv[2], "r") as f:
            ...
            print(f"publishing:...\n{json_format.MessageToJson(message_pb)}")
